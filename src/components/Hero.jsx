  ...
  return (
    <section id="home" className="relative min-h-[92vh] flex items-center overflow-hidden bg-[#0A3D62]">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute inset-0 bg-gradient-to-b from-[#0A3D62]/60 via-[#0A3D62]/80 to-[#0A3D62]" />
        <div className="absolute -right-24 -top-24 h-72 w-72 rounded-full bg-[#00A8FF]/20 blur-3xl" />
        <div className="absolute -left-24 -bottom-24 h-72 w-72 rounded-full bg-[#F1F2F6]/10 blur-3xl" />
      </div>
        ...
        >
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <motion.button
              ...
              className="px-6 py-3 rounded-lg bg-[#00A8FF] text-[#0A3D62] font-semibold shadow hover:brightness-110 transition"
            >
              Konsultasi Gratis
            </motion.button>
            <motion.button
      ...
      <a href="https://wa.me/6281234567890" target="_blank" rel="noreferrer" className="fixed bottom-6 right-6 z-50">
        <motion.div whileHover={{ y: -2 }} className="bg-[#25D366] text-white px-4 py-3 rounded-full shadow-lg hover:shadow-xl transition flex items-center gap-2">
